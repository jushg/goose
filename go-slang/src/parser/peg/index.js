...
function peg$parse(input, options) {
  ...
  var peg$e123 = peg$literalExpectation("__sys", false);
  var peg$e124 = peg$literalExpectation("__noop", false);
  var peg$e125 = peg$otherExpectation("identifier");
  var peg$e126 = peg$otherExpectation("type");
  var peg$e127 = peg$otherExpectation("type name");
  var peg$e128 = peg$literalExpectation("bool", false);
  var peg$e129 = peg$otherExpectation("type literal");
  var peg$e130 = peg$otherExpectation("pointer type");
  var peg$e131 = peg$otherExpectation("array type");
  var peg$e132 = peg$otherExpectation("channel type");
  var peg$e133 = peg$otherExpectation("chan-dual type");
  var peg$e134 = peg$otherExpectation("chan-out type");
  var peg$e135 = peg$otherExpectation("chan-in type");
  var peg$e136 = peg$otherExpectation("function type");
  var peg$e137 = peg$otherExpectation("function parameter type");
  var peg$e138 = peg$otherExpectation("block");
  var peg$e139 = peg$otherExpectation("statement list");
  var peg$e140 = peg$otherExpectation("declaration");
  var peg$e141 = peg$otherExpectation("constant declaration");
  var peg$e142 = peg$otherExpectation("variable declaration");
  var peg$e143 = peg$otherExpectation("function parameters");
  var peg$e144 = peg$otherExpectation("function declaration");
  var peg$e145 = peg$otherExpectation("operand");
  var peg$e146 = peg$otherExpectation("literal");
  var peg$e147 = peg$otherExpectation("nil literal");
  var peg$e148 = peg$literalExpectation("nil", false);
  var peg$e149 = peg$otherExpectation("bool literal");
  var peg$e150 = peg$literalExpectation("true", false);
  var peg$e151 = peg$literalExpectation("false", false);
  var peg$e152 = peg$otherExpectation("integer literal");
  var peg$e153 = peg$otherExpectation("string literal");
  var peg$e154 = peg$literalExpectation("\"", false);
  var peg$e155 = peg$classExpectation(["\t", [" ", "!"], ",", ".", ["0", "9"], "?", "_"], false, false);
  var peg$e156 = peg$otherExpectation("function literal");
  var peg$e157 = peg$otherExpectation("primary expression");
  var peg$e158 = peg$literalExpectation("void", false);
  var peg$e159 = peg$otherExpectation("selector in expression");
  var peg$e160 = peg$otherExpectation("index in expression");
  var peg$e161 = peg$otherExpectation("arguments");
  var peg$e162 = peg$otherExpectation("expression");
  var peg$e163 = peg$otherExpectation("unary expression");
  var peg$e164 = peg$otherExpectation("binary expression level 5");
  var peg$e165 = peg$otherExpectation("binary expression level 4");
  var peg$e166 = peg$otherExpectation("binary expression level 3");
  var peg$e167 = peg$otherExpectation("binary expression level 2");
  var peg$e168 = peg$otherExpectation("binary expression level 1");
  var peg$e169 = peg$otherExpectation("unary operator");
  var peg$e170 = peg$otherExpectation("comparison operator");
  var peg$e171 = peg$otherExpectation("addition operator");
  var peg$e172 = peg$otherExpectation("multiplication operator");
  var peg$e173 = peg$otherExpectation("statement");
  var peg$e174 = peg$otherExpectation("simple statement");
  var peg$e175 = peg$otherExpectation("unlabeled statement");
  var peg$e176 = peg$otherExpectation("labeled statement");
  var peg$e177 = peg$otherExpectation("expression statement");
  var peg$e178 = peg$otherExpectation("chan-statement");
  var peg$e179 = peg$otherExpectation("increment/decrement statement");
  var peg$e180 = peg$otherExpectation("assignment");
  var peg$e181 = peg$otherExpectation("'if' statement");
  var peg$e182 = peg$otherExpectation("pre-clause");
  var peg$e183 = peg$otherExpectation("else clause");
  var peg$e184 = peg$otherExpectation("expression of 'switch' statement");
  var peg$e185 = peg$otherExpectation("expression of 'case' clause");
  var peg$e186 = peg$otherExpectation("expression of switch's 'case'");
  var peg$e187 = peg$literalExpectation("default", false);
  var peg$e188 = peg$otherExpectation("'for' statement");
  var peg$e189 = peg$otherExpectation("'for' clause");
  var peg$e190 = peg$otherExpectation("'go' statement");
  var peg$e191 = peg$otherExpectation("'select' statement");
  ...
  var peg$f46 = function(str) { return makeNoOp(str.join('')) };
  var peg$f47 = function(v) { return v; };
  var peg$f48 = function(v) { return v; };
  var peg$f49 = function(v) { return v; };
  var peg$f50 = function() { return makeNilLiteralObj() };
  var peg$f51 = function(v) { return makeBoolLiteral(v === "true") };
  var peg$f52 = function(a, b) { return makeIntLiteralObj(Number(a + b.filter(bb => bb !== "_").map(i => i[1]).join(''))) };
  var peg$f53 = function(content) { return makeStrLiteralObj(content.join('')) };
  var peg$f54 = function(input, returnT, body) { return makeFuncLiteral(input, returnT, body ) };
  var peg$f55 = function(sym, typeArg, rest) {
    return makeSysCall(sym, typeArg, rest.map(r => r[2]));
  };
  var peg$f56 = function(sym, typeArg) {
  ...
  var peg$f58 = function(ident) { return { tag: "SELECTOR", ident } };
  var peg$f59 = function(index) { return { tag: "INDEX", index } };
  var peg$f60 = function() { return { tag: "CALL", args: [] } };
  var peg$f61 = function(arg1, rest) {
    const args = [arg1, ...(rest.map(r => r[2]))]
    return { tag: "CALL", args }
  };
  var peg$f62 = function(b, a) {
  ...
  var peg$f75 = function(label, stmt) { stmt.label = label; return stmt; };
  var peg$f76 = function(expr) { return makeExpressionStmt(expr) };
  var peg$f77 = function(lhs, rhs) { return makeChanStmt(lhs, rhs) };
  var peg$f78 = function(expr) { return makeIncStmt(expr) };
  var peg$f79 = function(expr) { return makeDecStmt(expr) };
  var peg$f80 = function(lhs, c, rhs) { return makeAssignmentStmt(lhs, c ? ":=" : "=", rhs) };
  var peg$f81 = function(lhs, rhs) { return makeAssignmentStmt(makeUnaryExpr(lhs, '*'), '=', rhs) };
  var peg$f82 = function(pre, cond, block, elseB) { return makeIfStmt(pre, cond, block, elseB) };
  var peg$f83 = function(a) { return a };
  var peg$f84 = function(block) { return block };
  var peg$f85 = function(pre, expr, cases) { return makeSwitchStmt(pre, expr, cases.map(cc => cc[0])) };
  var peg$f86 = function(a, b) { return makeCaseClause(a, b.map(bb => bb[0])) };
  var peg$f87 = function(a, b) { return makeCaseClause(a, [b]) };
  var peg$f88 = function(a) { return a; };
  var peg$f89 = function() { return "DEFAULT"; };
  var peg$f90 = function(clause, body) { return makeForStmt(clause.pre, clause.cond, clause.post, body) };
  var peg$f91 = function(body) { return makeForStmt(null, null, null, body)};
  var peg$f92 = function(pre, cond, post) { return { tag: "FOR_CLAUSE", pre, cond, post } };
  var peg$f93 = function(cond) { return { tag: "FOR_CLAUSE", pre: null, cond, post: null } };
  var peg$f94 = function(expr) { return makeGoStmt(expr) };
  var peg$f95 = function(cases) { return makeSelectStmt(cases.map(cc => cc[0])) };
  var peg$f96 = function(caseCl, b) { return makeSelectCase(caseCl, b.map(bb => bb[0])) };
  var peg$f97 = function(caseCl, b) { return makeSelectCase(caseCl, [b]) };
  var peg$f98 = function(a) { return { recvCh: a }; };
  var peg$f99 = function(a, b) { return { sendCh: a, val: b }; };
  var peg$f100 = function(a, op, b) { return { recvCh: b, to: a, op }; };
  var peg$f101 = function() { return "DEFAULT"; };
  var peg$f102 = function(expr) { return makeReturnStmt(expr) };
  var peg$f103 = function(label) { return makeBreakStmt(label) };
  var peg$f104 = function(label) { return makeContStmt(label) };
  var peg$f105 = function(label) { return makeGoToStmt(label) };
  var peg$f106 = function() { return makeFallthroughStmt() };
  var peg$f107 = function(expr) { return makeDeferStmt(expr) };
